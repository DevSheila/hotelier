        ...
        <div class="col-lg-12">
            <form role="form" id="booking" data-toggle="phonenumber">
                ...
                <div class="col-lg-12">
                    ...
                    <button type="submit"  class="btn btn-lg btn-success pull-right reservation-btn" style="border-radius:0%">Submit</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    const button = document.getElementsByClassName('reservation-btn')
